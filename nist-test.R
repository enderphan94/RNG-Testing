...
# By default prints ONE summary p-value per test (10-bin χ²). Use --per-seq for per-sequence CSV.
# ./nist-test.R <file.bin>
...
# Cumulative Sums (Cusum) (§2.7) — forward or reverse
